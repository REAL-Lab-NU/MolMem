...
def register_resolvers():
    try:
        ...
        # Dynamically generate CUDA device string based on GPU count (0,1,2,...)
        OmegaConf.register_new_resolver("cuda_devices", lambda num_gpus: ",".join(str(i) for i in range(int(num_gpus))))
    except:
